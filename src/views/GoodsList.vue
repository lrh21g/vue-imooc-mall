            ...
            <div class="accessory-list col-4">
              <ul>
                <li v-for="item in goodsList" :key="item.productId">
                  <div class="pic">
                    <a href="#"><img v-lazy="'/images/' + item.productImage" alt=""></a>
                  </div>
                  <div class="main">
...
<script>
  ...
  import Modal from '@/components/Modal.vue' // 弹窗
  ...
  export default {
    data() {
      return {
        ...
        mdShow: false, // 未登录状态下，弹窗是否显示
        mdShowCart: false // 已登录状态下，是否显示
      }
    },
    mounted() {
      this.getGoodsList()
    ...
    methods: {
      ...
      closeModal() { // 关闭弹窗
        this.mdShow = false // 未登录状态下，隐藏弹窗
        this.mdShowCart = false // 已登录状态下，隐藏弹窗
      }
    },
    components: {
      NavHeader,
